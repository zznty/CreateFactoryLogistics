...
public abstract class AbstractPanelModel extends FactoryPanelModel {
    public AbstractPanelModel(BakedModel originalModel) {
        super(originalModel);
    }

    @Override
    public void addPanel(List<BakedQuad> quads, BlockState state, FactoryPanelBlock.PanelSlot slot, FactoryPanelBlock.PanelType type, FactoryPanelBlock.PanelState panelState, RandomSource rand, net.neoforged.neoforge.client.model.data.ModelData data, RenderType renderType, boolean ponder) {
        PartialModel factoryPanel = getModel(type, panelState);
    ...
    protected abstract PartialModel getModel(FactoryPanelBlock.PanelType type,
