...
public class FactoryChemicalPanelRenderer extends SmartBlockEntityRenderer<FactoryChemicalPanelBlockEntity> {
    public FactoryChemicalPanelRenderer(
            BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void renderSafe(FactoryChemicalPanelBlockEntity be, float partialTicks, PoseStack ms,
    ...
    public static void renderBulb(FactoryPanelBehaviour behaviour, float partialTicks, PoseStack ms,
        ...
        PartialModel partial = behaviour.redstonePowered || missingAddress ?
                               FactoryMekanismModels.FACTORY_CHEMICAL_PANEL_RED_LIGHT
                                                                           :
                               FactoryMekanismModels.FACTORY_CHEMICAL_PANEL_LIGHT;
