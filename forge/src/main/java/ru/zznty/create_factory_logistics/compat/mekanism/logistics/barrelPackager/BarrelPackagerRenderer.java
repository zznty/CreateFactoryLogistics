...
public class BarrelPackagerRenderer extends SmartBlockEntityRenderer<BarrelPackagerBlockEntity> {
    public BarrelPackagerRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    protected void renderSafe(BarrelPackagerBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
