...
public final class IngredientTransfer {
                ...
                Map<String, ITypedIngredient<?>> ingredientUids = slotUidCache.computeIfAbsent(ingredient, s ->
                        s.getAllIngredients()
                                .map(typedIngredient -> {
                                    ...
                                    return Pair.of(ingredientHelper1.getUniqueId(typedIngredient.getIngredient(),
    ...
    @SuppressWarnings({"unchecked", "rawtypes"})
    private static @NotNull String getStackUid(IIngredientManager ingredientManager, GenericStack availableStack,
                                               UidContext context) {
        ...
        return ingredientHelper.getUniqueId(provider.unwrap(availableStack.key()), context);
    }
